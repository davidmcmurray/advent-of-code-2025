...
<details>
    ...
    I decided to loop through the ranges and check by brute force. Hypothetically, I could trade space to save time by pre-generating all the numbers that consist of repeating the digits of smaller numbers, up to the maximum top-end of any range, but it seems unnecessary for the inputs given.
</details>

<details>
    <summary>Day 2 Part 2</summary>
    todo!
</details>